...
@section('content')
    <div style=" height: 800px;" class="m-0 p-0 container-fluid">
            ...
            <div class="col-md-8">
                <div class="card border-0" style="border: 0px; background-color: transparent ">
                    ...
                    <div style="background-color: transparent; border: none;"
                        ...
                        <span style="font-style: italic" class="display-4" >Login here</span>
                    </div>
                    <div  class=" card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row mb-0 d-flex justify-content-center">
                                <div class="col-md-8 d-flex justify-content-center">
                                    <button type="submit"
                                        style="background-color: transparent; color: #000; border: solid 5px white"
